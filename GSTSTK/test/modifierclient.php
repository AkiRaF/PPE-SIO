...
$requete = $bdd->prepare("SELECT * FROM produits where id_prd Like '".$_GET['prd_nom']."' AND `stk_dispo` Like '".$_GET['mod2']."' ");
...
$arg= $requete->fetch();
		...
		<input type='text' name='prd_nom' class='form-control' id='prd_nom' value='$res[prd_nom]' required /><br>
		</div>";


		echo " <div class='container'>
		<label for='stk_dispo'>Reférence Produit :</label>
		<input type='text' name='stk_dispo' class='form-control' id='stk_dispo' value='$res[stk_dispo]' required /><br>
		</div>";
